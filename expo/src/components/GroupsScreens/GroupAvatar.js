      ...
      <View style={styles.container}>
        <View style={styles.topAvatars}>
          {avatars[0] && (
            <Image
              source={{
                uri: `file://${documentDirectory}/avatars/${avatars[0].avatar.filename}`,
              }}
        ...
        <View style={styles.bottomAvatars}>
          {avatars[1] && (
            <Image
              source={{
                uri: `file://${documentDirectory}/avatars/${avatars[1].avatar.filename}`,
              }}
          ...
          {avatars[2] && (
            <Image
              source={{
                uri: `file://${documentDirectory}/avatars/${avatars[2].avatar.filename}`,
              }}
