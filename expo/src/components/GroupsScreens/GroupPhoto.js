      ...
      <View style={styles.container}>
        <View style={styles.topPhotos}>
          {circlePhotos[0] && (
            <Image
              source={{
                uri: `file://${documentDirectory}/photos/${circlePhotos[0].photo.filename}`,
              }}
        ...
        <View style={styles.bottomPhotos}>
          {circlePhotos[1] && (
            <Image
              source={{
                uri: `file://${documentDirectory}/photos/${circlePhotos[1].photo.filename}`,
              }}
          ...
          {circlePhotos[2] && (
            <Image
              source={{
                uri: `file://${documentDirectory}/photos/${circlePhotos[2].photo.filename}`,
              }}
